...
A practical pattern for training on free or pre-emptible compute (Colab, Kaggle, spot instances) that disconnects without warning — so an interruption is a non-event, not a disaster.
